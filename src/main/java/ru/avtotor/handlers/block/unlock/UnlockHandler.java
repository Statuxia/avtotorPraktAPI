...
import ru.avtotor.handlers.block.lock.Lock;
import ru.avtotor.request.params.Params;

import java.io.IOException;
import java.nio.charset.StandardCharsets;

public class UnlockHandler extends DefaultHandler {

    public UnlockHandler(String endpoint, byte method, Params params) {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        try {
            ...
            JSONObject response = new Unlock(request).unlock();
